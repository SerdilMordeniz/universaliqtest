...
function StudyAreaChart({fetchedStudyAreaData}) {
    return (
        <div>
            <Chart
                chartType="BarChart"
                ...
                data={[
                    ...
                    ['Languages and literature', fetchedStudyAreaData.find(o => o.study_area === 'Languages and literature') ? parseInt(R.qnorm(fetchedStudyAreaData.find(o => o.study_area === 'Languages and literature').avg, 100, 15).toFixed(0), 10) : null, 'blue'],
