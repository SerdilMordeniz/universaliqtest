    ...
    return (
        <div className="home1">
            <div className="privacy-policy">
                ...
                <p>
                    Universaliqtest operates on www.universaliqtest.com. This page informs you of our policies regarding the collection,
                ...
                <p>
                    ...
                    that can be used to contact you. the only contact infformation we may ask you to provide is your email address.
                </p>
                <h2>Log Data</h2>
                <p>
                    Like many site operators, we collect information that your browser sends whenever you visit our Site
                    ("Log Data").
                    This Log Data includes information such as your computer's Internet Protocol ("IP") address,
                    ...
                    analyze this.
                    The ip address is only used to render the correct country flag.
                </p>

                <h2>Changes To This Privacy Policy</h2>
                <p>
                    This Privacy Policy is effective as of 26.05.2021 and will remain in effect except with respect to any
